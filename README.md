[![build](https://github.com/opspec-pkgs/semver.v2.sort/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/semver.v2.sort/actions/workflows/build.yml)
